...
parser.add_argument('--videofile',      type=str, required=True,   help='Input video file');
parser.add_argument('--reference',      type=str, required=True,   help='Folder name to save results');
parser.add_argument('--data_dir',       type=str, default='results', help='Output direcotry');
...
parser.add_argument('--min_face_size',  type=int, default=25,  help='Minimum face size in pixels');
